    ...
    <div class="modal fade" id="modalImport" role="dialog" aria-labelledby="favoritesModalLabel"> 
      <div class="modal-dialog" role="document"> 
        <div class="modal-content" style="border-radius: 17px;"> 
          ...
          <div class="modal-body"> 
            <FORM method="post" action="{{ '/bayi-import' }}" enctype="multipart/form-data"> 
              <div class="form-group">
              ...
              <div class="form-group"> 
                Gunakan file dengan format .xlsx. Download template <a href="{{ asset('template_excel/template_pasien_bayi.xlsx') }}">disini</a>
              </div> 
            </FORM> 
          </div> 
        </div> 
