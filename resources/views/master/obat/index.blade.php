                ...
                <div class="card-body">
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab_1">
                      ...
                      <FORM method="post" action="{{ url('/obat-import') }}" enctype="multipart/form-data"> 
                        <div class="form-group">
                        ...
                        <div class="form-group"> 
                          Gunakan file dengan format .xlsx. Download template <a href="{{ asset('template_excel/template_obat.xlsx') }}">disini</a>
                        </div> 
                      </FORM> 
                    </div>
                  </div>
