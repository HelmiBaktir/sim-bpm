        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <a href="{{url('/p_imunisasi_terlewati')}}" class="dropdown-item">
              <p><i class="fa fa-eyedropper mr-2"></i><span id="notif_atas_terlewati" style="color:red;">0</span>
                imunisasi terlewati</p>
            </a>
            <div class="dropdown-divider"></div>
            <a href="{{url('/p_imunisasi_hari_ini')}}" class="dropdown-item">
              <p><i class="fa fa-eyedropper mr-2"></i><span id="notif_atas_hari_ini" style="color:red;">0</span>
                imunisasi hari ini</p>
              <div class="dropdown-divider"></div>
              <a href="{{url('/p_imunisasi_akan_datang')}}" class="dropdown-item">
                <p><i class="fa fa-eyedropper mr-2"></i><span id="notif_atas_akan_datang" style="color:red;">0</span>
                  imunisasi akan datang</p>
              </a>
              <div class="dropdown-divider"></div>
              <a href="{{url('/p_obat_expired')}}" class="dropdown-item">
                <p><i class="fa fa-plus-square mr-2"></i><span id="notif_atas_expired" style="color:red;">0</span> obat
                  akan expired</p>
              </a>
              <div class="dropdown-divider"></div>
              <a href="{{url('/p_obat_stok')}}" class="dropdown-item">
                <p><i class="fa fa-plus-square mr-2"></i><span id="notif_atas_stok" style="color:red;">0</span> stok
                  obat menipis</p>
              </a>
          </div>
        </li>
