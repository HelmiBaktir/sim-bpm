  ...
  <div class="modal-dialog" role="document"> 
    <div class="modal-content" style="border-radius: 17px;"> 
      ...
      <div class="modal-body"> 
        <FORM method="post" action="{{ url('/layanan-kb/importLampiran') }}" enctype="multipart/form-data"> 
          ...
          <div class="form-group" id="field_input"> 
            ...
            <input type="hidden" name="no_regis" id="no_regis" value="{{$layanankbArr[0]['no_regis_pasien_dewasa']}}"></input>
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="container">
              <div class="gallery">
                <?php
                if(count($layanankbArr[0]->lampiran)>0)
                {
                  foreach ($layanankbArr[0]->lampiran as $key => $value) {
