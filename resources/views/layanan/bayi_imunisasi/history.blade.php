  ...
  <div class="modal-dialog" role="document"> 
    <div class="modal-content" style="border-radius: 17px;"> 
      ...
      <div class="modal-body"> 
        <FORM method="post" action="{{ url('/layanan-imunisasi/importLampiran') }}" enctype="multipart/form-data"> 
          ...
          <div class="form-group" id="field_input"> 
            ...
            <input type="hidden" name="no_regis" id="no_regis" value="{{$bayiArr[0]['id_pasien_bayi']}}"></input>
...
<div class="container-fluid">
  <div class="row mb-2">
    <div class="col-sm-6">
      <h3>History Pelayanan Imunisiasi</h3>
    </div>
    <div class="col-sm-6">
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="container">
              <div class="gallery">
                <?php
                if(count($bayiArr[0]->lampiran) > 0)
                {
                  foreach ($bayiArr[0]->lampiran as $key => $value) {
