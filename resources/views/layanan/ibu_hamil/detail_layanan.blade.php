      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-lg-3 col-4"  title="Tambah">
              <button type="button" class="btn btn-block btn-primary btn-sm" id="btnAdd">
                <a href="{{url('/layanan-ibu-hamil-observasi/'.$layanan[0]->id)}}" style="color: white">
            ...
            <div class="col-lg-3 col-4"  title="Tambah" style="margin-top: 1%;">
              <button type="button" class="btn btn-block btn-primary btn-sm" id="btnAdd">
                <a href="{{url('/layanan-ibu-hamil-tambah-history-persalinan/'.$layanan[0]->id)}}" style="color: white">
            ...
            <div class="col-lg-3 col-4"  title="Tambah" style="margin-top: 1%;">
              <button type="button" class="btn btn-block btn-primary btn-sm" id="btnAdd">
                <a href="{{url('/layanan-ibu-hamil-detail-tambah-nifas/'.$layanan[0]->id)}}" style="color: white">
