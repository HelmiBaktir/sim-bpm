...
<div class="container-fluid">
  ...
  <?php if (count($observasi) <= 0): ?>
    <form class="form-horizontal" id="form_submit" method="POST" action="{{url('/layanan-ibu-hamil-observasi')}}">
      <div class="row">
        <div class="col-12">
          <div class="card">
  ...
  <?php else: ?>
    ...
    <?php 
      $url = (count($observasi) > 0) ? "layanan-ibu-hamil-observasi-kala/".$observasi[0]->id : "observasiKala" ;
